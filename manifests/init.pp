...
#
# $server_metrics_graphite_enable::         Enable or disable Graphite metrics reporter. Defaults to true
#
...
class puppet (
  ...
  Optional[Boolean] $server_metrics_jmx_enable = $::puppet::params::server_metrics_jmx_enable,
  Optional[Boolean] $server_metrics_graphite_enable = $::puppet::params::server_metrics_graphite_enable,
  Optional[String] $server_metrics_graphite_host = $::puppet::params::server_metrics_graphite_host,
