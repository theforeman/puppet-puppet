...
class puppet (
  ...
  Optional[Array[String]] $facter_blocklist = $puppet::params::facter_blocklist,
  Optional[Array[String]] $facter_cachelist = $puppet::params::facter_cachelist,
  String $cache_ttl = $puppet::params::cache_ttl,
