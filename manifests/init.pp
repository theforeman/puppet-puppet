# @summary Installs and configures the puppet agent and optionally the puppet server
#
...
#
# @param systemd_randomizeddelaysec
...
#   Defaults to [ '127.0.0.1', '::1', $::ipaddress ].
#
# @param server_custom_trusted_oid_mapping
...
#
# @param server_puppetserver_version
...
#
# @param server_external_nodes
#   External nodes classifier executable.
#
# @param server_trusted_external_command
...
#
# @param server_envs_target
#   Indicates that $server_envs_dir should be a symbolic link to this target.
#
# @param server_common_modules_path
#   Common modules paths.
#
# @param server_git_repo_hook_mode
#   Git repository hook mode.
#
# @param server_git_repo_path
#   Git repository path on disk.
#
# @param server_git_repo_umask
#   Umask used during git operations.
#
# @param server_git_repo_group
#   Git repository group.
#
# @param server_git_repo_user
#   Git repository user.
#
# @param server_git_branch_map
...
#
# @param server_post_hook_content
#   Which template to use for git post hook.
#
# @param server_post_hook_name
#   Name of a git hook.
#
# @param server_storeconfigs
#   Whether to enable storeconfigs.
#
# @param server_ruby_load_paths
#   List of ruby paths.
#
# @param server_ssl_dir
#   SSL directory.
#
# @param server_ssl_dir_manage
...
#
# @param server_ssl_chain_filepath
...
#   Defaults to false.
#
# @param server_allow_header_cert_info
...
#
# @param server_puppetserver_metrics
#   Enable puppetserver http-client metrics.
#
# @param server_puppetserver_profiler
...
#
# @param server_puppetserver_telemetry
...
#
# @param server_puppetserver_trusted_certificate_extensions
