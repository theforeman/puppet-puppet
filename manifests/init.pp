...
class puppet (
  ...
  Optional[Variant[Enum[''], Stdlib::Absolutepath]] $server_foreman_ssl_ca = $puppet::params::server_foreman_ssl_ca,
  Optional[Variant[Enum[''], Stdlib::Absolutepath]] $server_foreman_ssl_cert = $puppet::params::server_foreman_ssl_cert,
  Optional[Variant[Enum[''], Stdlib::Absolutepath]] $server_foreman_ssl_key = $puppet::params::server_foreman_ssl_key,
