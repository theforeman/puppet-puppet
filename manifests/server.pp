...
class puppet::server(
  ...
  Optional[Variant[Enum[''], Stdlib::Absolutepath]] $foreman_ssl_ca = $puppet::server_foreman_ssl_ca,
  Optional[Variant[Enum[''], Stdlib::Absolutepath]] $foreman_ssl_cert = $puppet::server_foreman_ssl_cert,
  Optional[Variant[Enum[''], Stdlib::Absolutepath]] $foreman_ssl_key = $puppet::server_foreman_ssl_key,
