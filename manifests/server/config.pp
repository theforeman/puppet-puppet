...
class puppet::server::config inherits puppet::config {
  ...
  ## Foreman
  $pick_foreman_ssl_ca   = $puppet::server::foreman_ssl_ca   ? { '' => '', default => $puppet::server::ssl_ca_cert  }
  $pick_foreman_ssl_cert = $puppet::server::foreman_ssl_cert ? { '' => '', default => $puppet::server::ssl_cert     }
  $pick_foreman_ssl_key  = $puppet::server::foreman_ssl_key  ? { '' => '', default => $puppet::server::ssl_cert_key }
