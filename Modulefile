...
dependency 'theforeman/apache', '>= 1.3.0-rc3'
dependency 'theforeman/concat_native', '>= 1.3.0-rc3'
dependency 'theforeman/git', '>= 1.3.0-rc3'
dependency 'theforeman/passenger', '>= 1.3.0-rc3'
